...
def create_app():
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL') or os.getenv('MYSQL_URL') or os.getenv('MYSQLDATABASE_URL') or ''
    ...
    def profile(username):
        ...
        ensure_username(u)
        tweets = Tweet.query.filter_by(user_id=u.id).order_by(Tweet.created_at.desc()).all()
